	...
	OnCommand=function(self)
		...
		-- upper top dots
 		...
 		LoadActor("dots")..{
			...
			UpdateColoringMessageCommand=function(s) s:linear(0.5):diffuse(streakcolor):diffusealpha(0.15) end;
 		},
 		...
 		LoadActor("dots")..{
			...
			UpdateColoringMessageCommand=function(s) s:linear(0.5):diffuse( ColorLightTone(streakcolor) ):diffusealpha(0.15) end;
 		},
 		...
 		LoadActor("dots")..{
			...
			UpdateColoringMessageCommand=function(s) s:linear(0.5):diffuse( ColorLightTone(streakcolor) ):diffusealpha(0.2) end;
 		},
 		...
 		LoadActor("BLOCK")..{
			...
			UpdateColoringMessageCommand=function(s) s:linear(0.5):diffuse(streakcolor):diffusealpha(0.05) end;
 		},
 		...
 		LoadActor("BLOCK")..{
			...
			UpdateColoringMessageCommand=function(s) s:linear(0.5):diffuse( ColorLightTone(streakcolor) ):diffusealpha(0.1) end;
 		},
