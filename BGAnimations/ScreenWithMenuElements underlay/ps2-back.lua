return Def.ActorFrame{
	...
	Def.Sprite{
		...
		InitCommand=function(self)
			self:xy(SCREEN_CENTER_X,SCREEN_BOTTOM-128)
			:diffusealpha(0.8):zoomtowidth(SCREEN_WIDTH):vertalign(top)
		end;
		OnCommand=function(self)
			self:addy(128):decelerate(0.5):addy(-128)
		end;
		DoOffCommand=function(self)
			self:decelerate(0.5):addy(128)
		end;
