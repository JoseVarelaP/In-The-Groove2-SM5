return Def.ActorFrame{
	...
	Def.ActorProxy{
		BeginCommand=function(self) local Wheel = SCREENMAN:GetTopScreen():GetChild('RoomWheel'); self:SetTarget(Wheel); end,
		InitCommand=function(self) end,
	},

	LoadActor( THEME:GetPathG('ScreenSelectMusic','banner frame/NetRoom') )..{
