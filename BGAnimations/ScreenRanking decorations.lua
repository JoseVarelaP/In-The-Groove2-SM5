...
for i=1,2 do
    t[#t+1] = Def.Quad{
        OnCommand=function(s)
            s:xy( SCREEN_CENTER_X, i == 1 and 0 or SCREEN_BOTTOM ):vertalign( i == 1 and top or bottom )
    ...
    t[#t+1] = Def.Quad{
        OnCommand=function(s)
            s:xy( SCREEN_CENTER_X, i == 1 and 68 or SCREEN_BOTTOM-68 ):vertalign( i == 1 and top or bottom )
            :zoomto( 640,2 )
        end;
    };
end;
...
for i=1,THEME:GetMetric(Var "LoadingScreen","NumColumns") do
    ...
    t[#t+1] = Def.Sprite{
        ...
        OnCommand=function(s)
            s:animate(0):setstate( THEME:GetMetric(Var "LoadingScreen","ColumnDifficulty1") == "Difficulty_Easy" and i or i+1 )
