		...
		Def.BitmapText{
			...
			CheckGoalCommand=function(s)
				...
				SCREENMAN:SystemMessage(
					"Goaltype: ".. PROFILEMAN:GetProfile(player):GetGoalType() ..
					" Seconds: ".. PROFILEMAN:GetProfile(player):GetGoalSeconds() ..
					" Calories: ".. PROFILEMAN:GetProfile(player):GetGoalCalories() .. "\n" ..
					" Completed Seconds: ".. stats[1]:GetAliveSeconds() + stats[2]:GetAliveSeconds() ..
					" Completed Calories: ".. stats[1]:GetCaloriesBurned() + stats[2]:GetCaloriesBurned()
				)
