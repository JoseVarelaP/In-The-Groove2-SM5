	...
	Def.ActorFrame{
		...
		Def.ActorFrame{
			OnCommand=function(self)
				...
				OnCommand=function(self)
					self:x(15):horizalign(center):zoomx(0.5):zoomy(0.7):diffusealpha(0)
				end;
				SelectMenuOpenedMessageCommand=function(self)
					self:stoptweening():bounceend(0.2):diffusealpha(1):zoomx(0.7)
				end;
				...
				OnCommand=function(self)
					self:x(0):horizalign(right):zoomx(0.5):zoomy(0.7):diffusealpha(0):diffuseramp():effectperiod(1):effectoffset(0.20):effectclock("bgm"):effectcolor1(color("#FFFFFF")):effectcolor2(color("#E06060"))
				end;
				SelectMenuOpenedMessageCommand=function(self)
					self:stoptweening():bounceend(0.2):diffusealpha(1):zoomx(0.7)
				end;
